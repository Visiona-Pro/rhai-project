...
export default function ObrigadoBenefitList() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 my-2">
      {benefitsData.map((benefit, index) => {
        ...
        return (
          ...
          >
            <div className="flex-shrink-0 ob-glowing-orbit-container group-hover:scale-110 transition-all duration-300">
              <div className="ob-glowing-orbit-light" />
              <div className="ob-glowing-orbit-inner">
                <Icon size={11} strokeWidth={2} className="text-[#e7c279]" />
              </div>
            </div>
